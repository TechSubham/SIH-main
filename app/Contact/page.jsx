...
const ContactPage = () => {
  ...
  return (
    <div className={`${plusJakartaSans.className} h-full bg-slate-200 px-4 mt-3`}>
      <div className="max-w-6xl mx-auto bg-white p-8 rounded-xl">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-4" style={{ height: "70vh", overflow: "auto" }}>
